...
onset_delay: Option[Integer],  // User estimated (or default number of seconds) after cause measurement before a perceivable effect is observed
...
user_id: Option[Integer],  // user_id
